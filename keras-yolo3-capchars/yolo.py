...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='./support_codes/font/FiraMono-Medium.otf',
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if left + right not in chars:
                ...
                if float(label.split(' ')[1]) > chars[left + right][1]:
                    chars[left + right] = [label.split(' ')[0], float(label.split(' ')[1])]
                else:
                    continue
        ...
        print(end - start)
        return image, ''.join([char[1][0] for char in char_order])
